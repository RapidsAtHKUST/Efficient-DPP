/*
 * compile: nvcc -o split_blocks -O3 -arch=sm_35 split_blocks.cu -I /usr/local/cuda/samples/common/inc/ -I.
 */
...
__device__ void warp_histogram(int bucket_id, int bucket_bits, int *histo) {
